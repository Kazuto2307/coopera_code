...
def parse_args() -> argparse.Namespace:
    ...
    default_output = program_dir / "data/generated" / f"preference_human_sim_{stamp}.jsonl"
    default_summary = (
        program_dir / "data/generated" / f"preference_human_sim_{stamp}_summary.json"
    )
    default_intermediate = program_dir / "data/generated" / f"preference_human_sim_{stamp}_intermediate"
