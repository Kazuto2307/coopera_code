...
from iri_tfg_program.training_data.generate_training_data import (
    assemble_sample,
    load_profiles,
    load_situations,
    memory_entry,
...
SITU_DIR = PROJECT_ROOT / "data/generated" / "situations_hourly"
...
def parse_args() -> argparse.Namespace:
    ...
    default_output = program_dir / "data/generated" / f"preference_training_hourly_{stamp}.jsonl"
    default_summary = program_dir / "data/generated" / f"preference_training_hourly_{stamp}_summary.json"
