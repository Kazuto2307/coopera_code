...
from human_sim_preference_data import normalize_action_input, normalize_context_input

PROGRAM_DIR = Path(__file__).resolve().parent
DEFAULT_RAW = PROGRAM_DIR / "external_datasets" / "raw"
DEFAULT_OUTPUT = (
    PROGRAM_DIR / "generated_data" / "situations_hourly" / "situations_hourly.jsonl"
)
